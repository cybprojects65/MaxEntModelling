...
public class TestMaxEntENMAll_SSolea {
	
	public static void main(String[] args) throws Exception{
		String species="Solea solea";
		String sp = species.replace(" ", "_");
		
		String gridsA = "D:\\WorkFolder\\Experiments\\ENM in Adriatic Sea\\ASCEnvironmentalParametersForMaxEnt\\diva05\\ensembleSS\\";
		String outputA = "D:\\WorkFolder\\Experiments\\ENM in Adriatic Sea\\MaxEntModels\\ensemblediva05SS\\";
