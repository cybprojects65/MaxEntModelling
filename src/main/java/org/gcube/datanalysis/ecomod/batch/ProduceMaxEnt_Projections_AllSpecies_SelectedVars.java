...
public class ProduceMaxEnt_Projections_AllSpecies_SelectedVars {
	...
	public static void main(String[] args) throws Exception{
		...
		File gridsFolder1st = new File("D:\\WorkFolder\\Experiments\\ENM in Adriatic Sea v2\\Step 6 - MaxEnt Optimal\\ascAdriatic_per_year\\2015-2018\\");
		File gridsFolder2st = new File("D:\\WorkFolder\\Experiments\\ENM in Adriatic Sea v2\\Step 6 - MaxEnt Optimal\\ascAdriatic_per_year\\2019\\");
		File gridsFolder3st = new File("D:\\WorkFolder\\Experiments\\ENM in Adriatic Sea v2\\Step 6 - MaxEnt Optimal\\ascAdriatic_per_year\\2020\\");
		...
		File outputFolder = new File("D:\\WorkFolder\\Experiments\\ENM in Adriatic Sea v2\\Step 6 - MaxEnt Optimal\\MaxEnt\\");
		...
		for (String species:allSpp) {
			...
			String grids1st = gridsFolder1st.getAbsolutePath()+"/"+species+"/";
